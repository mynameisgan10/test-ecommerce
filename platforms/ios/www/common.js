...
/*!*****************************************!*\
  !*** ./src/app/service-cart.service.ts ***!
  \*****************************************/
/*! exports provided: ServiceCartService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ServiceCartService", function() { return ServiceCartService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");


var ServiceCartService = /** @class */ (function () {
    function ServiceCartService() {
        this.data = [{ cat_id: 0, cat_name: 'Clothings', product_id: 0, product_name: 'Shirt A', price: 25.90,
                image: 'assets/asd.jpg'
            },
            { cat_id: 4, cat_name: 'Accessories', product_id: 1, product_name: 'Hats', price: 21.90,
                image: 'assets/asd.jpg'
            },
    ...
    ServiceCartService.prototype.getIndividual = function (myid) {
        return this.data.find(function (e) { return e.cat_id === myid; });
    };
    // find Product individually
    ServiceCartService.prototype.getIndividualDetails = function (newID) {
        return this.data.find(function (e) { return e.product_id === newID; });
    };
    // Add to Cart
    ServiceCartService.prototype.getProducts = function () {
        return this.data; // Return Updated Data List Arr
    };
    ServiceCartService.prototype.getCart = function () {
        return this.cart; // Return Cart
    };
    ServiceCartService.prototype.addProduct = function (product) {
        this.cart.push(product); // Add to Cart
    };
    ServiceCartService.prototype.deleteCart = function (i) {
        this.cart.splice(i, 1);
    };
    ServiceCartService.prototype.getWishlist = function () {
        return this.wishlist;
    };
    ServiceCartService.prototype.addWishlist = function (product) {
        this.wishlist.push(product);
    };
    ServiceCartService.prototype.deleteWishlist = function (i) {
        this.wishlist.splice(i, 1);
    };
    ServiceCartService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [])
    ], ServiceCartService);
    return ServiceCartService;
}());
