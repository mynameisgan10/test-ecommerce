...
var HomePage = /** @class */ (function () {
    ...
    HomePage.prototype.openDetails = function (product, a) {
        alert('the prod is ' + a);
        this.router.navigate(['/product-details', a]);
    };
