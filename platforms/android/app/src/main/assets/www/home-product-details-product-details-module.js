...
var ProductDetailsPage = /** @class */ (function () {
    function ProductDetailsPage(cartService) {
        this.cartService = cartService;
        this.updatedProductArr = [];
        this.returnCart = [];
        this.returnDetailsCart = [];
    }
    ...
    ProductDetailsPage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [src_app_service_cart_service__WEBPACK_IMPORTED_MODULE_2__["ServiceCartService"]])
    ], ProductDetailsPage);
