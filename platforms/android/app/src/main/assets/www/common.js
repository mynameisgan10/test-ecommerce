...
var ServiceCartService = /** @class */ (function () {
    function ServiceCartService() {
        this.data = [{ cat_id: 0, cat_name: 'Clothings', product_id: 0, product_name: 'Latter Rain', price: 25.90,
                image: 'assets/asd.jpg'
            },
            { cat_id: 0, cat_name: 'Clothings', product_id: 1, product_name: 'Former Rain', price: 21.90,
                image: 'assets/asd.jpg'
            },
            { cat_id: 1, cat_name: 'Shoes', product_id: 22, product_name: 'Common Projects', price: 22.90,
                image: 'assets/cp.png' }];
        this.cart = [];
        // Add to Wishlist
        this.wishlist = [];
